...
public class JieunController {
	...
	/*
	 * @PostMapping("/logout") public String logout(HttpSession session) { // 세션에서
	 * 로그인 정보 제거 session.removeAttribute("loginMember");
	 * System.out.println("로그아웃 했습니다."); // 홈페이지로 리다이렉트 return "redirect:/"; }
	 */
