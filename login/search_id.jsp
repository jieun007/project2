  ...
  <body>
    ...
    <div class="login-box" style="color: white">
      <header class="form-header">
        <h1 style="text-align: center">(╬▔皿▔)╯</h1>
        <h1 style="text-align: center">아이디 내놔</h1>
      </header>
      <form class="form-row">
        <div class="user-box">
        ...
        <div>
          <a href="#" id="search_id" style="margin-top: 10px">
            <span></span>
            <span></span>
            <span></span>
            <span></span>
          ...
          <a href="find_PW" style="margin-left: 180">
            <span></span>
            <span></span>
            <span></span>
            <span></span>
